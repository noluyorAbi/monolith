...
<a href="assets/demo.mp4"><img src="assets/demo.gif" alt="Typing a GitHub handle, a build log counting up, the object rising out of its base plate, then switching between the four forms" width="100%"></a>
